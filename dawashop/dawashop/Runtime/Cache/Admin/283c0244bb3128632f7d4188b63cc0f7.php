...
<div id="header" class="wrap">
	...
	<div class="help"><a href="/dawashop/admin.php/Admin/Index/index.html">返回前台页面</a></div>
	<div class="navbar">
		<ul class="clearfix">
			<li><a href="index.html">首页</a></li>
			<li class="current"><a href="/dawashop/admin.php/Admin/Index/user.html">用户</a></li>
...
<div id="main" class="wrap">
	<div id="menu-mng" class="lefter">
		<div class="box">
			<dl>
				<dt>用户管理</dt>
				<dd><em><a href="add.html">新增</a></em><a href="index.html">用户管理</a></dd>
				<dt>商品信息</dt>
			...
			<form action="/dawashop/admin.php/Admin/User/getdata"  enctype="multipart/form-data" method="post">
				...
				<?php if(is_array($userinfo)): foreach($userinfo as $key=>$v): ?><tr>
					...
					<tr>
						...
						<td><input type="text" class="text" name="userName" value="<?php echo ($v["username"]); ?>" onblur="checkUserName(this.value)" /></td>
					    <td><span id="checkusernameResult" style="color:red"></span></td>
					</tr>
					<tr>
						<td class="field">姓名：</td>
						<td><input type="text" class="text" name="name" value="<?php echo ($v["name"]); ?>" onblur="checkName(this.value)" /></td>
					    <td><span id="checknameResult" style="color:red"></span></td>
					</tr>
					<tr>
						<td class="field">密码：</td>
						<td><input type="password" class="text" name="passWord" value="<?php echo ($v["userpasswd"]); ?>" onblur="checkPw(this.value)"/></td>
					...
					<tr>
						...
						<td><input type="text" class="text" name="email" value="<?php echo ($v["email"]); ?>"></input></td>
					</tr>
					<tr>
						<td class="field">手机号码：</td>
						<td><input type="text" class="text" name="mobile" value="<?php echo ($v["telno"]); ?>" onblur="checkTel(this.value)"/></td>
					    <td><span id="checktelResult" style="color:red"></span></td>
					</tr>
					<tr>
						<td class="field">送货地址：</td>
						<td><input type="text" class="text" name="address" value="<?php echo ($v["address"]); ?>" onblur="checkAddress(this.value)"/></td>
