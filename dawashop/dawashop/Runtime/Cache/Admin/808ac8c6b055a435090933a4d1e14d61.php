...
$(document).ready(function(){
	$("#sub").click(function(){
		...
		var url = "/dawashop/admin.php/Admin/Productattr/getattrdata";
		$.post(url,{attrgroup:$("#attrgroup").val(),attrName:$("#attrName").val()},function(msg){
			alert(msg);
		})
		}
	})
			...
			<form action="" method="post">
				<table class="form">
					<tr>
						...
						<td>
							<select id="attrgroup" value="">
							<option value="0">根栏目</option>
							<?php if(is_array($parentattr)): foreach($parentattr as $key=>$v): ?><option value="<?php echo ($v["attrgroup_id"]); ?>"><?php echo ($v["attr_name"]); ?></option><?php endforeach; endif; ?>
							</select>
						</td>
					</tr>
					<tr>
